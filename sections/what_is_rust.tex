...
\begin{frame}{What's wrong with systems languages?}
	\begin{itemize}
		\item It's difficult to write secure code (counterpoint\footnote{\url{https://www.usenix.org/conference/osdi18/presentation/cutler}}).
...
\begin{frame}{Quick Facts about Rust}
	...
	\begin{itemize}
		...
		\item Latest stable release: 1.29.1
		\item More than 80'000 commits on Github
